...
if(isset($_POST['project']))
{
  ...
  $budget=$_POST['Salary'];
    ...
    $query = "INSERT INTO worker_salary(p_no,w_id,w_name,salary) VALUES ($Pro_id,'$s_username','$s_name','$budget')";
...
<br>
      ...
      <form action="workersalary.php"  method="post">
    
      
        <h1>Give Salary</h1>
        
        <fieldset>
          <legend><span class="number"></span>Salary </legend>
          ...
          <label for="s_username">Worker Id:</label>
          ...
          <?php 
           ...
           ?>
            ...
            <label for="s_name">Worker name:</label>
          <select name="s_name">
